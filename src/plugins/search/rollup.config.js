...
const opts = {
    rootDir: __dirname,
    dist: path.resolve(__dirname, "dist/assets/plugins/search"),
...
module.exports = {
    input: {
        "search-view": path.resolve(opts.rootDir, './private/view/index.tsx'),
        "search-workers": path.resolve(opts.rootDir, './private/workers/index.ts')
    },
    output: {
        dir: opts.dist,
        sourcemap: true,
